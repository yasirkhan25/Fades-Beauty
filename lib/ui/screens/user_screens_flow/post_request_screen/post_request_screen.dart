...
import 'package:fades_and_beauty/ui/screens/user_screens_flow/post_request_notification/post_request_notification.dart';
import 'package:fades_and_beauty/ui/screens/user_screens_flow/post_request_screen/post_request_provider.dart';
...
class _PostRequestScreenState extends State<PostRequestScreen> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) {
        return PostRequestProvider();
      },
      child: Consumer<PostRequestProvider>(builder: (context, model, child) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: AppBarContainer(name: 'Post a Request'),
          ),
          ...
          /// Request Sent Button Called in bottomNavigationBar...................
          ///
          bottomNavigationBar: InkWell(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => PostRequestNotificationScreen()),
              );
            },
            child: CustomButton(
              text: 'Request Sent',
